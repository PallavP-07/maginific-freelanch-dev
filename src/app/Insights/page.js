...
const InsightsPage = (bannerData) => {
  ...
  return (
    <>
      <HeroBanner
        heroBanner={bannerData?.bannerData?.banner?.background_img?.filename_disk}
        header={bannerData?.bannerData?.banner?.title}
        description={bannerData?.bannerData?.banner?.description}
      />
              ...
              <div className="absolute left-6 bottom-6 right-6 md:left-12 md:bottom-10 md:right-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-4 md:gap-0">
                <div>
                  ...
                  <p className="text-[#F9F9F9] text-[12px] md:text-[14px] font-light leading-5 mt-2 md:mt-0 w-full md:w-3/4">
                    Brief description text of insight details. Lorem quis
                    nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                    commo. Brief description text of insight details. Lorem quis
                    nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                    commo.
                  </p>
                </div>
...
const Index = async () => {
  ...
  return (
    <InsightsPage bannerData={bannerData} />
  );
};
