  ...
  return (
    <>
      <div className="relative  w-full h-[780px] md:h-[680px] lg:h-[780px]">
        <Image
          className="w-full object-cover h-[780px] md:h-[680px] lg:h-[780px]"
          src={
            `${process.env.NEXT_PUBLIC_DIRECTUS_API_URL}/assets/${bannerData?.background_img?.filename_disk}` ||
            `/placeholder.png`
          }
          alt="hero-banner"
          layout="fill"
        ...
        <div className=" bg-gradient-to-r from-black/50 via-black/80 to-black/50 absolute inset-0 flex items-center justify-center text-white text-center">
          <div className=" lg:container lg:mx-auto text-center flex flex-col justify-center items-center">
            ...
            <h1 className="bg-gradient-to-r from-[#77BE9A]  to-white inline-block text-transparent bg-clip-text text-[48px] md:text-[60px] font-bold lg:text-[76px] lg:mb-4">
              {bannerData.subtitle}.
            </h1>
            <span
              className="text-lg font-normal break-words  lg:mx-28 leading-7"
